...
using CronExpressionDescriptor.Languages;
    ...
    public class ExpressionDescriptor
    {
        ...
        protected string GetString(string resourceName)
        {
            switch (_language)
            {
                ...
                case Language.zh_SG:
                    return GetString<Language_zh_CN>(resourceName);
                default:
                    return GetString<Language_zh_CN>(resourceName);
            }
        }
        ...
        /// Get const value .
        /// </summary>
        /// <typeparam name="TLanguage">Language</typeparam>
        /// <param name="resourceName">Name of the const name</param>
        /// <returns></returns>
        private string GetString<TLanguage>(string resourceName)
            where TLanguage : LanguageKeyValue<TLanguage>
        {
            return (LanguageKeyValue<TLanguage>.LanguageKeyValues.TryGetValue(resourceName, out string val) && null != val) ?
                val : LanguageKeyValue<Language_>.LanguageKeyValues.TryGetValue(resourceName, out val) ? val : null;
        }
